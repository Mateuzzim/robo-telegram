class Robot {
  constructor(config) {
    ...
    this.filters = Array.isArray(config.filters) ? config.filters : (RobotFilters ? RobotFilters.getDefaultFilters() : []);
  }
